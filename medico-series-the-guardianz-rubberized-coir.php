...
$product=$objMain->getRow("select * from product where id=26");
...
<p>The Luxe PT is a one-of-a-kind mattress that is uniquely designed and engineered to deliver the highest level of comfort and relaxation to you. It is available in diverse size specifications and we can even offer you custom size dimensions.
</p>
