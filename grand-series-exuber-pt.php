...
$product=$objMain->getRow("select * from product where id=2");
...
<div style="float: left; position: relative;  margin:5px; text-align: center;" >
    <label class="image-checkbox <?php echo $checked; ?>" style="padding: 10px 30px 0px 30px; margin-top: -10px;">
      ...
      <p style="font-size: 15px; "><?php if($psize['dimension']==6) echo "P.T "; else echo "E.T "; echo $psize['dimension']; ?>"</p>
                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab clearfix" id="tab-1">
                            <div class="text">
                                ...
                                <p>The Exuber PT is a premium quality mattress that is medium soft and medium firm on both the opposite sides. Made of soft and high resilience foam, Exuber PT offers you the right support when you are sleeping or casually lying down on the bed. The mattress is solid and stable, yet soft and bouncy at the same time, making it really comfortable for people of all ages. Made to provide 100% comfort to the users, the mattress is made of different high-quality materials. If you want a peaceful sleep at night, then this is mattress you want.</p>

<p>The Exuber PT Mattress has different layers of material underneath the top surface and one of them is the pocket springs. The use of these springs offers the correct bounce and softness to the mattress. It also helps to maintain a proper position while sleeping and promotes blood circulation to the entire body. The right amount of bounce makes sure that you are not resting on a rock-solid surface, which can be discomforting. Also, it helps to distribute the weight evenly across the entire mattress. Other layers consist of the Melange Knitted Fabric, PU SS layer, and SuperSoftFoam Technology.</p>

<p>Each and every layer that is available, offer their unique support to the mattress. You experience zero partner disturbance when both of you are sleeping on it at night. We have designed Exuber PT to keep movement isolated. With 10 years manufacturer warranty, the Exuber PT offers the best value for money.
</p>
