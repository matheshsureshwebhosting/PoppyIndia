...
$product=$objMain->getRow("select * from product where id=13");
...
<div style="float: left; position: relative;  margin:5px; text-align: center;" >
    <label class="image-checkbox <?php echo $checked; ?>" style="padding: 10px 30px 0px 30px; margin-top: -10px;">
      ...
      <p style="font-size: 15px; ">P.T <?php echo $psize['dimension']; ?>"</p>
                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab clearfix" id="tab-1">
                            <div class="text">
                                ...
                                <p>Selene PT is engineered to deliver the best comfort to our users. It is quite an update from the regular Selene mattress and brings to you a higher level of build quality and convenience. The Selene PT is designed with the help of woven jacquard fabric, giving it a premium feel. The fabric is resistant to abrasion and can last for many years to come if you maintain it the right way. The user of the jacquard fabric also helps to isolate movement, so you can sleep peacefully without any disturbance.</p>

<p>Just like any other high-quality mattress, the Selene PT is made of different layers of material. One of them is the quilt with PU Super Soft Foam. This adds an optimal level of softness and bounce to the mattress. So, you can sit and watch a movie or sleep in comfort throughout the entire night, without having to experience any discomfort on your back. Super Soft Foam helps to relieve any pressure point build-up around the legs, shoulders, knees, and the head. That is why your body relaxes at all times whenever you lie down on the Selene PT.</p>

<p>You'll be glad to know that we have used Bonnell Springs to design the Selene PT. This allows better air circulation throughout the mattress, and that is why it facilitates ventilation. It lasts long and gives a traditional feel to the users, making it a value for money purchase. Bonnell Springs make the mattress adds to the bounce factor and delivers more comfort.</p>

<p>Available at a budget-friendly price, the Selene PT will give you the opportunity to sleep peacefully throughout the night. We can deliver the mattress in different sizes.
</p>
