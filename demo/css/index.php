...
<body class="home boxed_wrapper">
    ...
    -->
            ...
            <div class="slide">
                <img src="images/banner/6.jpg" style="width: 100%;">
            </div>
            <div class="slide">
                <img src="images/banner/7.jpg" style="width: 100%;">
            </div>
        </div>
</section>
...
<div class="c-m4 hidedesktop">
            <div class="c-m4__sticky">
                <div data-w-id="8f049488-7c81-fe74-00b8-eecc80ba379d" class="c-m4__sticky-wrap">
                    <div class="c-m4__container sticky">
                        <div class="c-m4__copy-wrap">
                            <div style="display: block;" class="c-m4__copy c-m4__copy-1">
                                <h1 class="c-m4__title">Cuddle Buddy Mattress</h1>
                                <div class="c-linebreak-red"></div>
                                <p class="c-m4__copy"> Cuddle Buddy here has a hybrid mattress range made with premium quality 100% pure cotton as top layer and Natural latex, which is two inches thick and has bottom layer pocketed springsn.</p>
                        ...
                        <div class="c-m4__page-dots">
                            ...
                            <div style="background-color: rgb(119, 162, 64);" class="c-m4__dot c-m4__dot-2"></div>
                            <div style="background-color: rgb(119, 162, 64);" class="c-m4__dot c-m4__dot-3"></div>
                        </div>
                    </div>
                    ...
                    <div class="c-m4__circle-wrap sticky"><div class="c-m4__circle"></div></div>
                    <div class="c-m4__products-wrap">
                        <div class="c-m4__product-wrapper">
                            <div class="c-m4__product-shot">
                                <img
                                    src="images/products/cuddle-buddy/hybrid/1.jpg"
                                    loading="lazy"
                                    sizes="(max-width: 479px) 100vw, (max-width: 991px) 70vw, 740px"
                                    srcset="
                                        images/products/cuddle-buddy/hybrid/1.jpg  500w,
                                        images/products/cuddle-buddy/hybrid/1.jpg  1442w
                                    "
                                    alt=""
                                    class="c-m4__image"
                                />
                        ...
                        <div class="c-m4__product-wrapper">
                            <div class="c-m4__product-shot">
                                <img
                                    src="images/products/cuddle-buddy/latex/1.jpg"
                                    loading="lazy"
                                    sizes="(max-width: 479px) 100vw, (max-width: 991px) 70vw, 740px"
                                    srcset="
                                        images/products/cuddle-buddy/latex/1.jpg  500w,
                                        images/products/cuddle-buddy/latex/1.jpg  1442w
                                    "
                                    alt=""
                                    class="c-m4__image"
                                />
                        ...
                        <div class="c-m4__product-wrapper">
                            <div class="c-m4__product-shot">
                                ...
                                <img
                                    src="images/products/cuddle-buddy/hrfoam/1.jpg"
                                    loading="lazy"
                                    sizes="(max-width: 479px) 100vw, (max-width: 991px) 70vw, 740px"
                                    srcset="
                                        images/products/cuddle-buddy/hrfoam/1.jpg  500w,
                                        images/products/cuddle-buddy/hrfoam/1.jpg  1442w
                                    "
                                    alt=""
                                    class="c-m4__image"
                                />
        ...
        <div class="row">
            <div class="box column col-md-9 col-6 text-left">
                <div class="inner-container" data-eco-ben-modal="">
                    <p style="color: #FFF; font-size: 48px;margin-bottom: 20px;/* color: #67de0d; */text-transform: uppercase;line-height: 65px; font-weight: bold;">Be One our Lucky 500 Buddies, Save Upto 25%, Shop Now </p>
...
<section class="classes-section sec-pad hideonmobiles" style="padding-bottom: 0;">
        <div class="container">
            <div class="sec-title centred">
                <h5>Meet</h5>
                <h1>Our other range of Products</h1>
            </div>
            <div class="row">
                ...
                <div class="gallery-block">
                    <div class="inner-block wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                        ...
                        <div class="lower-content">
                            ...
                            <div class="text">The pressure is not on you. It's on the mattress.</div>
                        </div>
                    </div>
                </div>
                <div class="gallery-block">
