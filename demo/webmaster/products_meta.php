<?php include("lib/common.php"); $menu='slider'; ?><!DOCTYPE html> <?php $ptype="Product";
$res=$objMain->getRow("select * from product where id=".$id);

 ?>
<html lang="en">
<head>
    <?php include("inc/header_scripts.php"); ?>
    <title>Update Meta <?php echo $res['product_name']; ?></title>
    <!--summernote-->
    ...
    <div class="app-body">
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0">Update Meta <?php echo $res['product_name']; ?>
                <a href="products.php?category=<?php echo $res['category']; ?>" class="btn btn-danger btn-sm pull-right"><i class="fa fa-mail-reply"></i> Back</a>
                </h4>
                <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                    <li class="breadcrumb-item"><a href="dashboard.php" class="default-color">Home</a></li>
                    <li class="breadcrumb-item"><a href="products.php" class="default-color">Products</a></li>
                ...
                <div class="row">
                    ...
                    <div class=" col-md-12">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <form method="post" action="init.php?module=admin&action=products&do=meta&id=<?php echo $id; ?>" id="frm" enctype="multipart/form-data" >
