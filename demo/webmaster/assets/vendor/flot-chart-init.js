...
$(function() {
    var data = [{
        label: "Completed Tasks (20)",
        data: 30
    }, {
        label: "Non initiated Tasks",
        data: 10
    }, {
        label: "25% Completed Tasks",
        data: 20
    }, {
        label: "50% Completed Tasks",
        data: 20
    }, {
        label: "75% Completed Tasks",
        data: 20
    }];
    var options = {
        series: {
        ...
        colors: ["#A768F3", "#FF518A", "#36a2f5", "#ff0054", "#00bc30"],
        tooltip: true,
        tooltipOpts: {
            defaultTheme: false
        }
