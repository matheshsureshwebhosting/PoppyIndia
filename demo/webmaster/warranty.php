<?php include("lib/common.php"); include("lib/session_check.php"); $menu='slider'; 
 ?>
<!DOCTYPE html> <?php $ptype='30 Days Trial Warranty'; ?>
<html lang="en">
<head>
...
$results=$objMain->getResults("select * from warranty  order by id desc");
                    if(!empty($results)){ $i=0;
                        foreach($results as $result){ $i++; 
                            ...
                            <tr>
                                ...
                                <td><a href="../uploaded_files/<?php echo $result['invoice']; ?>" download>download invoice</a></td>
                                <td><?php echo $result['customer_name']; ?></td>
                                <td><?php echo $result['mobileno']; ?></td>
                                <td><?php echo date("d-m-Y",strtotime($result['date_of_birth'])); ?></td>
                                <td><?php echo date("d-m-Y h:i:s A",strtotime($result['apply_date'])); ?></td>
                            </tr>
