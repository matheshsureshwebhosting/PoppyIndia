...
$results=$objMain->getResults("select * from pages order by sort_order");
                    if(!empty($results)){ $i=0;
                        foreach($results as $result){ $i++; 
                            ...
                            <tr>
                                ...
                                <td><a href="page_update.php?id=<?php echo $result['id']; ?>" class="btn btn-success btn-sm">Update</a>                           </tr>
