            ...
            $order_total+=$item['qty']*$item['price'];
             ...
             <div class="row col-lg-12 singleproduct" id="product_<?php echo $key; ?>">
                                            ...
                                            <label style="font-size: 14px; color:#979191;"><?php echo $category_name; ?></label><br>
                                                ...
                                                <div class="colors">
                                                 ...
                                                 $colors=explode(",",$product['product_colors']); 
                                                    ...
                                                    <li>
                                                      <label>
                                                        <input type="radio" name="color<?php echo $key; ?>" value="<?=$color?>" onclick="updatecart(<?php echo $item['productid']; ?>,<?php echo $key; ?>);" <?php if($color==$item['product_color']){ echo "checked"; } ?>>
                            ...
                            <div class="col-lg-1 col-xs-2 qty">
                                <input type="number" placeholder="Qty" id="qty<?php echo $key; ?>" value="<?php echo $item['qty']; ?>" min="1" onchange="updatecart(<?php echo $item['productid']; ?>,<?php echo $key; ?>);">
                                        ...
                                        <h4>
                                            ...
                                            <span style="width: 100%;float: left;font-size: 14px;"><b style="color: #84226D;">FREE</b> for <?php echo $product['product_name']." ".$item['dimension']."\""; ?></span>
                                               <div class="colors">
                                                 ...
                                                 $colors=explode(",",$prod1['product_colors']); 

                                                      foreach ($colors as $f_key => $color2) {
                                                    ?>
                                                    <li>
                                                      <label>
                                                        <input type="radio" name="freecolor<?php echo $key; ?>" value="<?=$color2?>" onclick="updatefreeproductcolor(<?php echo $item['productid']; ?>,<?php echo $key; ?>);" <?php if($color2==$item['product_free_color']){ echo "checked"; } ?>>
                                                        <span class="swatch" style="background-color:<?=$color2?>"></span>
                                                      </label>
                                                    </li>
                                                  <?php }} ?>
                                              </ul>
            ...
            <div class="row col-lg-12 singleproduct" id="net_det" style="<?php if(!isset($_SESSION['discount_coupon'])) echo 'display: none;'; ?>">
                        ...
                        <div class="othre-content">
                            ...
                            <div class="coupon-box clearfix">
                                <input type="text" name="coupon" id="coupon" placeholder="Apply Coupon Code" value="<?php if(isset($_SESSION['dic_coupon_code'])){ echo $_SESSION['dic_coupon_code']; }?>">
