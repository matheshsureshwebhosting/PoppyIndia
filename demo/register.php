...
<?php $page=$objMain->getRow("select * from pages where id=9");
echo $page['html_code']; ?>
...
<?php include("inc/body_tag_manager.php"); ?>
    ...
    <section class="checkout-section">
     ...
     <label for="checkbox"><span>I agree to subscribe to get latest offers</span></label>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 customer-column">
                    <div class="customer">Existing Customer? <a href="login">Click here to Login</a></div>
                </div>
            </div>
                </div>
