...
<?php $misc=$objMain->getRow("select * from miscellaneous where id=1 and type_value!=''");
                        if(!empty($misc)){ ?>
                            ...
                            <?php 
                            if(!isset($_SESSION['dic_coupon_code']))
                            {
                                $cup_de=$objMain->getRow("select * from coupon where coupon_code='".$misc['coupon_code']."'");
                                 $_SESSION['dic_coupon_code']=$misc['coupon_code'];
                                 $_SESSION['dic_coupon_value']=$cup_de['discount_value'];
                                 $_SESSION['dic_coupon_type']=$cup_de['discount_type'];
                            ...
                            <nav class="main-menu navbar-expand-lg">
                                ...
                                <div class="navbar-collapse collapse clearfix">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li><a href="trial.php">30 Day's Trial</a></li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
