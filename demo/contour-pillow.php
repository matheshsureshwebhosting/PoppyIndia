...
<div class="sharethis-inline-share-buttons" style="margin-top:34px"></div>
    ...
    <video width="1024" id="myvideo" muted class="hideonmobile">
      <source src="assets/videos/pillow 2_1.mp4" type="video/mp4">
        ...
        <div class="row cols-m-t-1">
            ...
            <div class="column col-md-4 fs-body-1">
                <div class="p-x-content text-center">
                    ...
                    <p>the pillow with original 100% natural latex, which is extremely breathable and hypo-allergic. Moreover, the cell structure of the latex soap pillow has a natural ventilation system and rich in anti-microbial properties. So, you can say the pillow is free from the attack of dust mites, mildew, and molds. Get this latex pillow from poppyindia.com for exceptional support to the neck and head.</p>
                </div>
            </div>
        </div>
    </div>
...
<?php 
if($category['parent_id']==0) 
$related=$objMain->getResults("select * from product where id=33 or id=34 or id=29 or id=30 or id=31");
else 
