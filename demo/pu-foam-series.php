...
<?php $page=$objMain->getRow("select * from pages where id=16");
echo $page['html_code']; ?>
...
<body class="boxed_wrapper">
    ...
    <section class="classes-section classes-page-section sec-pad">
        <div class="container">
<?php $categories=$objMain->getResults("select * from category where parent_id=3");
...
<?php
    ...
    <?php $products=$objMain->getResults("select * from product where category=3");
        if(!empty($products)){
            foreach($products as $product) { ?>
