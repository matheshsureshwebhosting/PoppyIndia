...
$product=$objMain->getRow("select * from product where id=14");
                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab clearfix" id="tab-1">
                            <div class="text">
                                ...
                                <p>The Luxe mattress comes with cutting-edge design and a high level of comfort to our users. It is one of the very popular mattresses we have under our brand name. We have used fine High GSM knitted fabric to cover the top layer of the mattress. High GSM fabric gives a fantastic feel to the mattress, offering more of the traditional style. It can last long and is resistant to wear and tear over time. If you can maintain the fabric properly, it will surely last for many years to come in the near future.</p>

<p>Super Soft Foam layer is one of the USP of the Luxe mattress. We wanted to make sure that our users enjoy a high level of comfort and convenience when using our mattress. That is why our designers have added a layer of the Super Soft Foam layer. It makes the mattress more bouncy and allows your back to rest whenever you are lying or sitting over it. This layer helps in proper weight distribution of your body and that prevents any pressure point</p>

<p>Thermo bonded felt delivers better durability and strengthens the overall build quality. Not only that, but it also absorbs your body weight and molds itself around it, in order to provide relief to the different body parts. Just like a lot of our other mattresses, we have selected Bonnell Springs to design the Luxe as well. Get more cushioning and bounce, whenever you jump on the mattress or lie down.</p>

<p>With so many layers added to the Luxe mattress, you can be assured to enjoy a peaceful sleep at night on a regular basis. We offer our mattress in different sizes and can also customize it based on your requirements.</p>
