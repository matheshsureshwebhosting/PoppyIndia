...
$product=$objMain->getRow("select * from product where id=23");
                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab clearfix" id="tab-1">
                            <div class="text">
                               ...
                               <p>Neck Defenders are designed in a special shape that helps in protecting the cervical spine. The bones are supported by muscles and tendons, which are highly sensitive—the cushioned spongy neck defenders from Poppy’s ease the regions under stress. With the experts on board, we have helped create these defenders who can bring the lost natural neck position. Many people have trouble sleeping due to stress in the neck area. Some people have pain throughout the day, as they have slept in an inappropriate position. Thus neck defenders are the possible solution to reducing these morning neck pains and relieving the sore or stiff neck. </p>

<p>At Poppy’s, neck defenders are made of memory foam, and hence you get that fluffy soft undercoat naturally. They are recommended by many doctors who have trouble sleeping. It is an alternative to your traditional pillows as they improve the quality of sleep. They offer complete support to your neck and back and can be molded in shape for the overall comfort. </p>

<p>This can provide dream sleep for back-sleepers and who has been working throughout the day in front of the computers and laptop. Now shop your neck defender from us and experience the peaceful nights.
</p>
