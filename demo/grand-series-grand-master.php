...
$product=$objMain->getRow("select * from product where id=4");
...
<div style="float: left; position: relative;  margin:5px; text-align: center;" >
    <label class="image-checkbox <?php echo $checked; ?>" style="padding: 10px 30px 0px 30px; margin-top: -10px;">
      ...
      <p style="font-size: 15px; ">D.T <?php echo $psize['dimension']; ?>"</p>
                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab clearfix" id="tab-1">
                            <div class="text">
                                ...
                                <p>Getting good rest and a night of even better sleep at the end of a hard working day is crucial for every human being. Your body needs to rest and re-energize by resting on a comfortable surface. So you will always need a reliable mattress that is going to offer excellent comfort to you, and we can think of anything but the Grand Master. It is one of the most premium mattresses that our team has designed to date. We have brought together different best-in-class materials that offer unrivaled comfort, deep pressure relief, and support.</p>

<p>The Grand Master mattress is a pleasant blend of stunning comfort and exquisite luxury. The overall look and feel of the mattress are going to impress you at first sight. Support your back, head, neck, shoulders, and even the legs, without compromising on the comfort levels while lying down on this brilliant mattress.</p>

<p>Dual Construction type and Natural Latex Foam offers superior durability and tenacity to the Grand Master mattress. Limited motion transfer is another key advantage of using it. Mattresses that are too firm can lead to a painful experience while sleeping. But you don't need to worry about that when using the Grand Master mattress. It never fails to provide a combination of bounce and firmness.</p>

<p>We have used the latest Memory Foam that offers the right bounce and firmness to you. It is especially beneficial for those who sleep on their sides because the Memory Foam allows for pressure point relief. It is highly resilient, and the body-conforming feature instantly molds to your body curves.</p>

<p>Do you think that the Grand Master mattress is what you need for a good night's sleep? Then don't forget to check out more details regarding the pricing only at our official website.
</p>
