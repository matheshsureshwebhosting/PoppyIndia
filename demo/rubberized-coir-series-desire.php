...
$product=$objMain->getRow("select * from product where id=5");
                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab clearfix" id="tab-1">
                            <div class="text">
                                ...
                                <p>Our Rubberised coir series is a truly impressive set of mattresses that guarantees you a sound sleep every night. We have spent a lot of time researching about the materials to use for this series and finally found the perfect ones. Our Desire mattress is designed with Twill weaving fabric and tight top stitching. We wanted to make sure that the mattress is not only comfortable but feels good and soft. The twill weaving process gives a premium feel to the upper layer of the mattress. Along with the superb tight top stitching, our mattress is much more resistant to wrinkling and wear & tear.</p>

<p>Desire mattress is quilted with HD PU foam and is the main layer of the product. Insulation is a very important factor to consider when buying a mattress. That is why we used PU foam, which is a great material that facilitates insulation all the time. The PU foam delivers high performance at a low thickness level and comes with a high strength to weight ratio. The foam is also resistant to moisture. So you don't need to worry about any moisture damage.</p>

<p>Another reason why we believe that you will love our Desire mattress is because of the high-density coir. It gives very good support to the body and distributes your weight perfectly. Our mattress is 100% eco-friendly, and it is made of non-harmful materials. Since the Desire is a coir mattress, it offers anti-dust properties.
</p>

<p>Do visit our website and check out all the sizes in which the mattress is made available to you.
</p>
