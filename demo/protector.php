...
$product=$objMain->getRow("select * from product where id=21");
                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab clearfix" id="tab-1">
                            <div class="text">
                                ...
                                <p>For most of you, the best place for your home is bed. Wherever you go, thinking of going back to your bed is the best feeling. Also, imagine you have the coziest bed of all time. But what will happen someone ruins your bed? Those spills and aging for the bed are common, given the scenario. That’s why we always recommend the protectors to your beds. The protectors are like the fitted sheet that is generally waterproof. They do not allow any spills to be absorbed in the layer or from the soaking. They are guarding against the vulnerable major issues for the bed.  
Poppy’s Protectors can cover in all four sides entirely and gives the assured protection to your mattress. Our protectors help in waterproofing and help keep your bed away from the dust, mites, bacteria, and other allergens. Shop Protectors from Poppys’ now and keep the spirits of your bed alive forever.         
</p>
