...
<TITLE>Pay Now</title>
  ...
  <input type="text" name="callback_url" value="https://localhost/poppy/payment-success.php">
<input type="text" name="cancel_url" value="https://localhost/poppy/payment-failure.php">
