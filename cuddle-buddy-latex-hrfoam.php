...
$product=$objMain->getRow("select * from product where id=31");
...
<div class="col-lg-12" style="margin-top: 50px; background: #FFF; padding-top: 50px; padding-bottom: 50px;">
    ...
    <video width="1024" id="myvideo" muted class="hideonmobile">
      <source src="assets/videos/hrfoam.mp4" type="video/mp4">
        ...
        <div class="row cols-m-t-1">
            <div class="column col-md-4 fs-body-1">
                <div class="p-x-content text-center">
                    <h3 class="m-b-6">2" Natural Latex with HR Foam</h3>
                    <p>Being an organic two inches latex with PU HR foam is naturally resilient and exceptionally comfortable for a nice sleep. Arguably, the latex with foam is the best mattress to sleep on.</p>
                </div>
            </div>
            <div class="column col-md-4 fs-body-1">
                <div class="p-x-content text-center">
                    <h3 class="m-b-6">Why HR Foam?</h3>
                    <p>The HR foam gives you a ultimate Back Support and Durability unlike many Cheap Foams HR Foams are made without any Harmful Chemicals .So that we stand by Our quality</p>
                </div>
            </div>
            <div class="column col-md-4 fs-body-1">
                <div class="p-x-content text-center">
    ...
    <div class="container container-lg">
        <div class="row">
            ...
            <div class="box column col-md-3 col-6 text-center">
                <div class="inner-container" data-eco-ben-modal="">
                    <div class="center m-b-6">
                        <img src="images/icons/zipper.png" style="width: 65px;">
                    </div>
                    <p class="fs-label" style="font-weight: bold; color: #FFF; ">Zipper</p>
                </div>
            </div>
            <div class="box column col-md-3 col-6 text-center">
                <div class="inner-container" data-eco-ben-modal="">
...
<section class="classes-section sec-pad" style="padding-bottom: 0px;">

    <div class="container">

    <img alt="Why Choose the Hybrid?" src="images/hrfoam.jpg" />
