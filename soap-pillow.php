                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab clearfix" id="tab-1">
                            <div class="text">
                               ...
                               <p>The soft, fully latex soap pillow is highly recommended to those suffering from neck pain.  These easy-to-fit pillows are exceptionally designed for extra support to the neck. We promise to deliver complete comfort to those who have the habit of tossing over the bed all night. Complete support to the neck and extra soft cushiony latex pillow makes you feel like putting your head over the cloud and sleep in heaven. The latex is equally distributed inside the pillow. It has the lowest density so that the weight of your head is distributed equally on the pillow to have a comfortable and relaxing sleep. </p>
...
<?php 
if($category['parent_id']==0) 
$related=$objMain->getResults("select * from product where id=32 or id=34");
else 
