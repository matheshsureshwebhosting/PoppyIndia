...
$product=$objMain->getRow("select * from product where id=3");
...
<div style="float: left; position: relative;  margin:5px; text-align: center;" >
    <label class="image-checkbox <?php echo $checked; ?>" style="padding: 10px 30px 0px 30px; margin-top: -10px;">
      ...
      <p style="font-size: 15px; ">B.T <?php echo $psize['dimension']; ?>"</p>
                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab clearfix" id="tab-1">
                            <div class="text">
                                ...
                                <p>Grandeur is one of our most premium mattresses at our website. We have designed this unique bed mattress keeping mind the utmost comfort of our customers. Grandeur combines beauty and high-level comfort, offering you sound sleep without any backaches. Special box type construction of the mattress can easily fit into beds of different sizes. The tufted finish provides a soft cushioning to the mattress, so you can sit or lie down in a comfortable way. Amazing weight distribution of this particular mattress helps to achieve a convenient sleeping posture.</p>

<p>Grandeur is made of Natural Latex Foam and it is one of the main highlight of this mattress. It is not only comfortable to use, but a supportive sleep surface as well. The foam conforms around your body and helps to keep the spine in alignment whenever you sleep. The hips and shoulders benefit the most, as it provides an excellent cushion to both these body parts. The ability to remove pressure point discomfort is one of the reasons to choose Natural Latex.</p>

<p>Grandeur also features Pocketed Spring build technology, which offers a greater degree of support to your body weight. Nowadays, a Pocketed Spring mattress is more popular when compared to traditional open coil mattresses. Pocketed Spring reduces the risk of pressure point to build up drastically over time. Our mattress offers consistent firmness across the surface and isolates any movement.</p>

<p>Grandeur is available in different sizes and the price is going to vary based on the size you choose. Get yourself this brilliant mattress and treat yourself with a relaxing sleep every night.</p>
