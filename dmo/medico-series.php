...
<?php $page=$objMain->getRow("select * from pages where id=15");
echo $page['html_code']; ?>
...
<section class="testimonial-style-two">
    ...
    <?php $categories=$objMain->getResults("select * from category where parent_id=5");
...
<div class="card" style="margin-bottom: 40px; box-shadow:1px 3px 12px rgba(229, 229, 229, 0.8); padding: 20px;">
            <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                            ...
                            <div class="row">
                                                <div class="col-md-7 col-xs-12">
                                                    <p class="price thin-font">INR <?php echo $objMain->INR($product['product_price']); ?></p>
...
<?php
    ...
    <?php $products=$objMain->getResults("select * from product where category=5");
        if(!empty($products)){
            foreach($products as $product) { ?>
