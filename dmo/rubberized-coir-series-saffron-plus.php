...
$product=$objMain->getRow("select * from product where id=7");
                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab clearfix" id="tab-1">
                            <div class="text">
                                ...
                                <p>Sleep is one of the most necessary activities that everyone should be part in. You just cannot compromise on your sleep, if you want to work and progress through the day. Sleep is the only way to revitalize the human body. Our saffron Plus is a premium quality mattress that has a lot of exciting layers and features. We have put into use a woven jacquard fabric, to match the overall style statement of the mattress. We wanted to add a bit of class along with more durability and so we selected jacquard fabric.</p>

<p>You'll be pleased to know that saffron Plus is made of quilted HD PU Foam layer. PU Foam being of the best materials to be used in the mattress delivers the best kind of comfort. The overall tenacity and softness of the mattress are quite balanced and that is why you feel so good whenever you lie down on the Saffron Plus. There is an extra bounce factor for all the pillow fights, thanks to the 5 mm PU foam.</p>

<p>If you are looking for a durable and less maintenance mattress, then the saffron Plus is a great companion for your bed. It can insulate the body temperature and make the surface more comfortable to sleep on. You feel less pressure around different parts of the body like the shoulders, knees, head, neck, etc. That is a fantastic benefit of the high-density coir.</p>

<p>Starting from a very affordable price, the Saffron Plus is easily going to be within your budget. Let us know which feature impressed you the most and which mattress you like.</p>
