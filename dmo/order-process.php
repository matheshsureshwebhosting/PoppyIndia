...
var options = {
    ...
    "callback_url":"https://www.poppyindia.com/payment-success.php",
    "prefill": {
        "name": "",
    ...
    "modal": {
        "ondismiss": function(){
            window.location.replace("https://www.poppyindia.com/payment-failure.php");
        }
    }
};
var rzp1 = new Razorpay(options);
rzp1.on('payment.failed', function (response){
    window.location.replace("https://www.poppyindia.com/payment-failure.php?type="+response.error.description);
});
