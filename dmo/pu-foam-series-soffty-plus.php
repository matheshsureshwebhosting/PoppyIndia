...
$product=$objMain->getRow("select * from product where id=10");
                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab clearfix" id="tab-1">
                            <div class="text">
                                ...
                                <p>A firm upgrade from the Soffty mattress, the Soffty Plus is a premium quality mattress that is available in a wide variety of sizes. Our designers engineered the mattress in such a way that you enjoy a good night's sleep always. We have made use of treated knitted fabric in order to cover the top layer of the mattress. As you may know, that Knitted fabric is one of the best materials that can feel soft, yet it is very durable for many years to come in the future. It ensures smoothness and air permeability at all times you lie down on it for a peaceful sleep.</p>

<p>You will be glad to know that while making this mattress, we have included an extra layer of Super Soft Foam Layer. This benefits you by delivering an additional layer of comfort and contributes to the overall bounce factor. This layer absorbs your body weight and impact on the mattress and uniformly distributes it across the entire surface. Any pressure point around the shoulders, back, neck or the head, is therefore eliminated completely.</p>

<p>Inclusion of the HD PU Foam has offered you a very high level of consistent comfort. From now on you can jump, sit or sleep on the mattress without having to worry about any discomfort. Soffty Plus is available in diverse dimensions that easily fits every bed you can imagine. Visit our website and check out the mattress and further details regarding it.
</p>
