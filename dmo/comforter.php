...
$product=$objMain->getRow("select * from product where id=20");
                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab clearfix" id="tab-1">
                            <div class="text">
                                ...
                                <p>At Poppy’s, we carefully craft the Comforter with the right efforts involved in design aesthetics and sleep techniques. We assume everyone has undergone the situation described below. You have a hard day office, and you come back home and straight away hit the bed. All you need is to get pampered, and that can make your day possibly well when you get up. What do you think is missing? AC? Dim lights? Well! At Poppy’s, we have the right answer for you. Choose Comforter over anything and feel the peace at your inner self. </p>

<p>Comforters are a perfect choice of investment if you are thinking of self-care. We recommend Poppy’s comforters as they are soft, flexible, and designed for all weather conditions. Whether you are looking for perfect use of AC or just the outside too cold, all you need is a comforter. With the combination of natural and synthetic, our external covering will enhance the plush feeling throughout the nights. The fiber used is siliconized microfiber, which is one of the resilient options available in the market. They help in retaining the shape and stay fluffy over a long duration. The sewn cover on the outside gives you’re a secured comfort preventing any clumping of the fill. </p>

<p>Choose comforters from Poppy’s and embrace the self-care. Purchase your bed comforter online and get the cozy sleep of all time. </p>
