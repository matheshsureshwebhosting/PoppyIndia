        ...
        <div class="row cols-m-t-1">
            <div class="column col-md-4 fs-body-1">
                <div class="p-x-content text-center">
                    <h3 class="m-b-6">6inch Single Core Latex</h3>
                    <p>The pure latex mattress is made from six inches of latex layers only which is extracted and process naturally from the rubber tree. We Make a single Block of Latex layer and we don’t Cut and Paste like other brands do</p>
                </div>
            </div>
            <div class="column col-md-4 fs-body-1">
                <div class="p-x-content text-center">
