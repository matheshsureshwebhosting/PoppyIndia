...
<title>Box in Mattress - Cuddle Buddy :: Buy Mattress Online - India&#039;s Best Mattress Brand</title>
...
<body class="boxed_wrapper">
    ...
    <section class="page-title centred" style="">
        <div class="container">
            <div class="content-box">
                <h1>Cuddle Buddy</h1>
                <p style="color: #FFF;">India 1<sup>st</sup> complete natural mattress </p>
    ...
    <section class="classes-section classes-page-section sec-pad">
        <div class="container">
<?php $categories=$objMain->getResults("select * from category where id=16");
...
<div class="card" style="margin-bottom: 40px; box-shadow: 0 30px 50px rgba(229, 229, 229, 0.8); padding: 20px;">
            <div class="row">
                    <div class="col-lg-5">
                            <figure class="image-box"><a href="<?php echo $product['url_slug']; ?>"><img src="images/products/<?php echo $product['cover_image']; ?>" alt="" style="border-radius: 10px;"></a></figure>
                    </div>
                    <div class="col-lg-6">
