                            ...
                            <nav class="main-menu navbar-expand-lg">
                                ...
                                <div class="navbar-collapse collapse clearfix">
                                    <ul class="navigation clearfix">
                                        <li class="dropdown children"><a href="#">Bed in Box</a>
                                            <ul>
                                                <li><a href="cuddle-buddy-hybrid.php">Organic Luxury Hybrid</a></li>
                                                <li><a href="cuddle-buddy-latex.php">Organic Latex</a></li>
                                                <li><a href="cuddle-buddy-latex-hrfoam.php">Eco Cloud</a></li>
                                            </ul>
                                        </li>
