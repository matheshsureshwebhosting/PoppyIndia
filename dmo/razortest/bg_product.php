...
$product=$objMain->getRow("select * from product where id=1");
...
<!-- page wrapper -->
<body class="boxed_wrapper" style="background: url('images/background/websitebackground1.jpg');">
...
<div class="sharethis-inline-share-buttons" style="margin-top:34px"></div>
            ...
            <div class="product-info-tabs" style="background: #FFF; padding: 50px;">
                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab clearfix" id="tab-1">
                            <div class="text">
                                ...
                                <p>A good mattress is crucial to enjoying a peaceful sleep through the night. A premium quality mattress ensures that your body tests in the best position and support it throughout the time you are lying down on the bed. Our Exuber Mattress does the same. Made of the best quality materials and designed to provide the maximum support, our Exuber Mattress delivers you 100% comfort all the time.</p>

<p>Exuber Mattress is perfectly designed to keep all kinds of movement isolated. That means, if your partner moves, you won't zig. You can maintain the best sleeping position always. We have kept in mind the bounce factor while designing the Exuber Mattress. It holds just enough bounce that you will need for all the cute pillow fights and jumping on the bed.</p>

<p>Our Exuber Mattress is perfectly made of pocket springs which make provides an exquisite balance between soft and rugged feel. It is firm enough to support you for a long time and also, quite soft to offer a higher level of comfort. This helps to maintain a proper posture for the human body and improves blood circulation. Our mattress absorbs the weight of the body and provides cozy support to the neck, back, shoulders, head, and legs.</p>

<p>The Exuber Mattress is made of different layers of premium material. Each of them offers different functionality and support to you. The top layer is made of Melange Knitted Fabric, beneath the top layer is the quilt with SuperSoftFoam Technology and, then comes the PU SS layer. All the layers are sensitive to your body weight and mold themselves properly to provide support while lying down.</p>

<p>If you are in search of a mattress that can deliver you the highest level of comfort when you sleep or watch a movie overnight, then our Exuber Mattress is the best option for you.</p>
