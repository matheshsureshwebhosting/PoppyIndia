...
$product=$objMain->getRow("select * from product where id=8");
...
<div style="float: left; position: relative;  margin:5px; text-align: center;" >
    <label class="image-checkbox <?php echo $checked; ?>" style="padding: 10px 30px 0px 30px; margin-top: -10px;">
      ...
      <p style="font-size: 15px; "><?php if($psize['dimension']=='6') echo "E.T "; echo $psize['dimension']; ?>"</p>
                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab clearfix" id="tab-1">
                            <div class="text">
                                ...
                                <p>Our wide range of mattresses are designed and delivered to our customers all over India for the only purpose - give them a good sleep. A solid span of sleep every day can help your body to stay fit and fine over the long term. Saffron DLX is one of the most popular mattresses of the entire Rubberised Coir series. There is a lot of reasons for its popularity and one of them is the use of Knitted fabric. This premium quality and the rigid fabric feels really good and has an aesthetic appeal to it. You get attracted to it whenever you look at the mattress. Don't forget about the fantastic Euro top stitch also.</p>

<p>Super soft layer ensures that the mattress protects anyone during a sudden impact. The soft and rugged feel of this layer made it quite comfortable and durable at the same time. We introduce you to the high-density coir with the Saffron DLX. Our coir is made of naturally produced materials, which gives it the tag of eco-friendly. You don't need to worry about any dust allergies because there are no harmful items that is used to manufacture this mattress.</p>

<p>Saffron DLX features a 10 mm PU Foam that speaks not only comfort but more durability. You can start experiencing the change from the very first day. Our mattress absorbs your weight and temperature, molds itself around the body and provides the right support that gives your the ability to sleep peacefully in any position you actually want to. PU foam can also neglect any movement and isolates it. The addition of the PU foam is best for back rest and for spine alignment in the long run.</p>

<p>Which feature do you like the most? Do check out further details regarding it on the website.</p>
...
<section class="classes-section classes-page-section sec-pad">
        <div class="container">
             ...
             <div class="sec-title style-two">
                <h5>Related</h5>
                <h1>Rubbeerized Coir Series Products</h1>
            </div>
