<?php include("lib/common.php"); include("lib/session_check.php"); $menu='slider'; 
 ?>
<!DOCTYPE html> <?php $ptype='Subscribers'; ?>
<html lang="en">
<head>
...
function changeurl(type){
  if(type=='search'){ 
  document.getElementById("search_form").action="report_subscribers.php";
  } else if(type=='export'){ 
  document.getElementById("search_form").action="report_subscribers_export.php";
  }
