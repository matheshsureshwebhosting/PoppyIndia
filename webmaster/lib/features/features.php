...
echo "insert into pu_slider set heading='', sub_heading='', sort_order='".$sort_order."'".$qry;
    ...
    public function AddCoupon(){ extract($_REQUEST);
        ...
        $this->Query("insert into coupon set description='', coupon_code='".$coupon_code."', discount_type='".$discount_type."', discount_value='".$discount_value."', start_date='".$start_date."', expire_date='".$expire_date."'");
    ...
    public function UpdateCoupon($id){ extract($_REQUEST);
        ...
        $this->Query("update coupon set coupon_code='".$coupon_code."', discount_type='".$discount_type."', discount_value='".$discount_value."', start_date='".$start_date."', expire_date='".$expire_date."' where id=".$id);
    ...
    public function UpdateMiscellaneous($id){ extract($_REQUEST);
        ...
        $this->Query("update miscellaneous set type_value='".$type_value."' where id=".$id);
