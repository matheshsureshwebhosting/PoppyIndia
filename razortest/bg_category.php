...
<!-- page wrapper -->
<body class="boxed_wrapper" style="background: url('images/background/websitebackground.jpg');">
    ...
    <section class="classes-section classes-page-section sec-pad">
        <div class="container">
<?php $categories=$objMain->getResults("select * from category where parent_id=1");
