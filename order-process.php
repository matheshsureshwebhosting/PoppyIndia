...
success: function (obj) {
  ...
  window.location.href = 'https://poppyindia.com/success.php?msg=placed&tracking_id='+data['id'];
  else 
  window.location.href = 'https://poppyindia.com/payment-failure.php';
}
});
},
    "prefill": {
    ...
    "modal": {
        "ondismiss": function(){
            window.location.replace("https://poppyindia.com/payment-failure.php");
        }
    }
};
var rzp1 = new Razorpay(options);
rzp1.on('payment.failed', function (response){
    window.location.replace("https://poppyindia.com/payment-failure.php?type="+response.error.description);
});
